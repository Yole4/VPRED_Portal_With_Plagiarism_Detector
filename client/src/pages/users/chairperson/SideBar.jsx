                    ...
                    <nav className="mt-2">
                        <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li className="nav-item has-treeview">
                                <span onClick={(e) => navigate('/chairperson-public-RorE')} className="nav-link span-cursor">
                            ...
                            {/* =========================================================== RESEARCH WORKS ======================================================================================== */}
                            <li className="nav-item has-treeview">
                                <span onClick={(e) => navigate('/chairperson-RorE-Works')} className="nav-link span-cursor">
                                    <i className="nav-icon fas fa-copy" />
                                    <p>
                            ...
                            {/* =========================================================== AUTHOR ACCOUNTS ======================================================================================== */}
                            <li className="nav-item has-treeview">
                                <span onClick={(e) => navigate('/chairperson-author-account')} className="nav-link span-cursor">
