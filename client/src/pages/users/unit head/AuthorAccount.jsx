...
function AuthorAccount() {
    ...
    useEffect(() => {
        const fetchAllAuthorAccount = async () => {
            try {
                const response = await axios.get(`${backendUrl}/unitHead/fetch/all-author/${requestId}`, {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
                                            ...
                                            {listAuthor.length === 0 ? (
                                                ...
                                                filteredList.map(item => (
                                                    <tr className="hover">
                                                        ...
                                                        <td>
                                                            <button style={{ backgroundColor: 'green' }} onClick={() => editBtn(item)} data-toggle="modal" data-target="#editAuthor" type="button" className="btn btn-primary edit_me">
                                                                EDIT <i className="fas fa-edit" />
                                                            </button>
                                                        </td>
                                                        <td>
                                                            <button onClick={() => deleteA(item)} name="delete_btn" className="btn btn-danger">DELETE <i className="fa fa-trash" /></button>
                                                        </td>
                                                    </tr>
                                                ))
                                            )}
