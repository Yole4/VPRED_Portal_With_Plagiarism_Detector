            ...
            <nav className="main-header navbar navbar-expand navbar-primary navbar-dark">
                ...
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item d-none d-sm-inline-block">
                        <span style={{ cursor: 'pointer' }} onClick={(e) => navigate('/unitHead-homePage')} className="nav-link">Home</span>
                    </li>
                    {/* =============================================================== PUBLICIZE RESEARCH ================================================================================== */}
                    <li className="nav-item d-none d-sm-inline-block">
                        <span style={{ cursor: 'pointer' }} onClick={(e) => navigate('/unitHead-public-RorE')} className="nav-link">Research & Extension Programs</span>
                    </li>
                </ul>
                {/* Right navbar links */}
