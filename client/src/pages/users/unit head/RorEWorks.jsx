...
function RorEWorks() {
  ...
  // ###############################################################  FETCH ALL DATA ADDED EACH UNIT HEAD   ###################################################################################
  ...
  useEffect(() => {
    const fetchAllRorE = async () => {
      try {
        const response = await axios.get(`${backendUrl}/unitHead/fetch/all-RorE/${user_id}`, {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
      ...
      <div className="content-wrapper" style={{ pointerEvents: deleteVisible || isLoading || scanLoading || isScanDone ? 'none' : '' }}>
        ...
        <div className="card shadow mb-4" id="data1">
          <div className="card-header py-3">
            <h6 className="m-0 font-weight-bold text-primary"><span style={{ fontSize: 20 }}><span id="a1" style={{ display: 'visible', fontSize: 20 }}>{userData && userData.RorE} Works </span></span>
                          ...
                          <tr className="hover" key={item.id}>
                            <td>
                              ...
                              <ul aria-labelledby="dropdownSubMenu1" className="dropdown-menu border-0 shadow">
                                ...
                                <li>
                                  <button type="button" data-toggle="modal" data-target="#editData" onClick={() => updateDataBtn(item)} className="dropdown-item edit_me">Edit</button>
                                </li>
                                <li>
