            ...
            <nav className="main-header navbar navbar-expand navbar-primary navbar-dark">
                ...
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item d-none d-sm-inline-block">
                        <span style={{ cursor: 'pointer' }} onClick={(e) => navigate('/author-myWorks')} className="nav-link">Home</span>
                    </li>
                    {/* =============================================================== PUBLICIZE RESEARCH ================================================================================== */}
                    <li className="nav-item d-none d-sm-inline-block">
                        <span style={{ cursor: 'pointer' }} onClick={(e) => navigate('/author-public-works')} className="nav-link">Research & Extension Programs</span>
                    </li>
                </ul>
                {/* Right navbar links */}
