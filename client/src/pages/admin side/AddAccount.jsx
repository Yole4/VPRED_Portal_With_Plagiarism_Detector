...
function AddAccount() {
    ...
    // ###############################################################  UPDATE CHAIRPERSON ACCOUNT REQUEST  ############################################################################################
    ...
    return (
        <div>
            <div className="content-wrapper" style={{ pointerEvents: deleteVisible || isLoading ? 'none' : '' }}>
                ...
                {/* End of Adding Chairperson account */}

                <div className="modal fade" id="yole123" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style={{ pointerEvents: isLoading ? 'none' : '', }}>
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
