    ...
    return (
        <div>
            <div className="content-wrapper" style={{ pointerEvents: deleteVisible || isLoading || scanLoading || isScanDone ? 'none' : '' }}>
                ...
                {/* Logout */}
                <div className="modal fade" id="history" tabIndex={-1} role="dialog" aria-hidden="true">
                    <div className='history-class' role="document" style={{ marginTop: '20%', width: '80%', marginLeft: '10%' }}>
